    ...
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="bg-gray-800 rounded-lg p-6">
          <h2 className="text-xl font-bold mb-6 text-green-500">Envie sua Mensagem</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                >
                  ...
                  <option value="feedback">Feedback sobre serviços</option>
              ...
              <button type="submit" className="w-full bg-green-600 hover:bg-green-700 text-white py-3 px-4 rounded-md transition-colors font-medium">
                Enviar Mensagem
              </button>
            </form>
          )}
        ...
        <div>
          <div className="bg-gray-800 rounded-lg p-6 mb-6">
            <h2 className="text-xl font-bold mb-4 text-green-500">Informações de Contato</h2>
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-300">contato@alibisdigital.com.br</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-300">(11) 99999-8888</p>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-300">Avenida Paulista, 1000</p>
          ...
          <div className="bg-gray-800 rounded-lg p-6">
            <h2 className="text-xl font-bold mb-4 text-green-500">Redes Sociais</h2>
